            ...
            <tr>
                ...
                <td class="align-middle">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('Book.show', $book->id) }}" type="buttom" class="btn btn-secondary" >Detail</a>
                        <a href="{{ route('Book.edit', $book->id) }}" type="button" class="btn btn-warning">Edit</a>
                        <form action="{{ route('Book.destroy', $book->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Yakin mau hapus buku?')">
                            @csrf
                            @method('DELETE')
